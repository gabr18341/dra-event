    ...
    <section className='py-10 md:py-20 px-8 md:px-20 skills-section'>
        <div className="container px-4 md:px-12 ">
            <div className="flex gap-5 flex-wrap">
                <Card className="w-[275px] p-6 flex items-center  gap-4 flex-grow skills-card border-[#acd147]">
                    ...
                    <CardHeader className="p-0">
                        <CardTitle className="text-[#143745] text-2xl">Friendly Team</CardTitle>
                    </CardHeader>
                </Card>
                <Card className="w-[275px] p-6 flex items-center  gap-4 flex-grow skills-card border-[#acd147]">
                    <CardContent className="p-0">
                    ...
                    <CardHeader className="p-0">
                        <CardTitle className="text-[#143745] text-2xl">Support 24/7</CardTitle>
                    </CardHeader>
                </Card>
                <Card className="w-[275px] p-6 flex items-center  gap-4 flex-grow skills-card border-[#acd147]">
                    <CardContent className="p-0">
                    ...
                    <CardHeader className="p-0">
                        <CardTitle className="text-[#143745] text-2xl">Perfect Work</CardTitle>
                    </CardHeader>
                </Card>
                <Card className="w-[275px] p-6 flex items-center  gap-4 flex-grow skills-card border-[#acd147]">
                    <CardContent className="p-0">
                    ...
                    <CardHeader className="p-0">
                        <CardTitle className="text-[#143745] text-2xl"> Brilliant Idea </CardTitle>
                    </CardHeader>
                </Card>
